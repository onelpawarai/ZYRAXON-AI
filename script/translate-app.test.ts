...
describe("translate app", () => {
  ...
  test("maps product locale codes to their glossaries", () => {
    expect(glossaryFile("fr")).toBe(".zyraxon/glossary/fr.md")
    expect(glossaryFile("zh")).toBe(".zyraxon/glossary/zh-cn.md")
    expect(glossaryFile("zht")).toBe(".zyraxon/glossary/zh-tw.md")
  })
