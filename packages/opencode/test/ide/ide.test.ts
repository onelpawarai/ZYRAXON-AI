...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ZYRAXON_CALLER", () => {
    process.env["ZYRAXON_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ZYRAXON_CALLER", () => {
    process.env["ZYRAXON_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ZYRAXON_CALLER", () => {
    process.env["ZYRAXON_CALLER"] = "unknown"
