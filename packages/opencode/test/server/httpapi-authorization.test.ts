...
const noAuthLayer = ServerAuth.Config.configLayer({ password: Option.none(), username: "zyraxon" })
const secretLayer = ServerAuth.Config.configLayer({ password: Option.some("secret"), username: "zyraxon" })
