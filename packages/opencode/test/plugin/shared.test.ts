...
describe("parsePluginSpecifier", () => {
  ...
  test("parses scoped npm package without version", () => {
    expect(parsePluginSpecifier("@zyraxon/acme")).toEqual({
      pkg: "@zyraxon/acme",
      version: "latest",
    })
  })
  ...
  test("parses scoped npm package with version", () => {
    expect(parsePluginSpecifier("@zyraxon/acme@1.0.0")).toEqual({
      pkg: "@zyraxon/acme",
      version: "1.0.0",
    })
  })
  ...
  test("parses scoped package with git+https url", () => {
    expect(parsePluginSpecifier("@zyraxon/acme@git+https://github.com/opencode/acme.git")).toEqual({
      pkg: "@zyraxon/acme",
      version: "git+https://github.com/opencode/acme.git",
    })
  })
  ...
  test("parses scoped package with git+ssh url containing another @", () => {
    expect(parsePluginSpecifier("@zyraxon/acme@git+ssh://git@github.com/opencode/acme.git")).toEqual({
      pkg: "@zyraxon/acme",
      version: "git+ssh://git@github.com/opencode/acme.git",
    })
  })
