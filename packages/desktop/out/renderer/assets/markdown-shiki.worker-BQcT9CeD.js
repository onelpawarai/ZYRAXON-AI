...
const bundledLanguagesInfo = [
  ...
  },
  {
    "id": "angular-html",
    "name": "Angular HTML",
    "import": (() => import("./angular-html-Cd5NRdZj.js").then(function(n) {
      return n.f;
    }))
  },
  {
    ...
    "import": (() => import("./angular-ts-5qS_8V0-.js"))
  },
  {
    "id": "apache",
    "name": "Apache Conf",
...
async function highlight(request) {
  try {
    ...
    if (request.complete) {
      const result2 = instance.codeToTokens(request.text, { lang: language, theme: "ZYRAXON" });
...
//# sourceMappingURL=markdown-shiki.worker-BQcT9CeD.js.map
