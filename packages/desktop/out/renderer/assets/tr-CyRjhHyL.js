const dict = {
  ...
  "provider.connect.apiKey.description": "{{provider}} hesabınızı bağlamak ve ZYRAXON'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1": "ZYRAXON Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix": " gidin; ardından hesabınızı bağlayarak ZYRAXON'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak ZYRAXON'da {{provider}} modellerini kullanın.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "ZYRAXON'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  ...
  "wsl.onboarding.windowsRestartRequired": "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından ZYRAXON'u tekrar açın.",
  ...
  "error.chain.mcpFailed": 'MCP sunucusu "{{name}}" başarısız oldu. Not: ZYRAXON henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "settings.general.row.colorScheme.description": "ZYRAXON'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
...
//# sourceMappingURL=tr-CyRjhHyL.js.map
