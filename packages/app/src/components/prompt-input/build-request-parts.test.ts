...
describe("buildRequestParts", () => {
  ...
  test("preserves an external attachment source path for the model", () => {
      ...
      images: [
        {
          ...
          sourcePath: "C:\\Users\\Luke\\AppData\\Roaming\\ai.zyraxon.desktop.beta\\opencode.global.dat",
          mime: "text/plain",
    ...
    expect(result.requestParts.find((part) => part.type === "file")?.filename).toBe(
      "C:\\Users\\Luke\\AppData\\Roaming\\ai.zyraxon.desktop.beta\\opencode.global.dat",
    )
  })
